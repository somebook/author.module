module Author
class TerminalsController < SpaceController
  ...
  def create
    ...
    if @terminal.save
      redirect_to shard_language_account_terminals_path, notice: t("author.terminal.notice.create_success")
    else
      render :form
    end
  end
  ...
  def destroy
    ...
    @terminal.destroy
    redirect_to shard_language_account_terminals_path, notice: t("author.terminal.notice.delete_success")
  end
  ...
  def update
    ...
    if @terminal.update_attributes(params[:terminal])
      redirect_to shard_language_account_terminals_path, notice: t("author.terminal.notice.update_success")
    else
      render :form
    end
  end
